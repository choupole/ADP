...
<div class="min-height-200px">
    ...
    <div class="pd-20 card-box mb-30">
        <div class="clearfix">
            ...
            <p class="mb-30">Ajout d'une nouvelle parcelle</p>
        </div>
        <div class="wizard-content">
            <form id="myForm" class="tab-wizard wizard-circle wizard" action="{{ route('parcelles.store') }}" method="POST">
                @csrf
                @method('POST')
                		    <!-- Step 2 -->
<!-- Step 2 -->
...
<section>
    <div class="row">
        ...
        <div class="col-md-6">
            <div class="form-group">
                <label>Sexe :</label>
                <input type="text" name="sexe" class="form-control proprietaire-sexe" readonly>
            </div>
        </div>
        <div class="col-md-12">
            <div class="form-group">
                <label>Adresse :</label>
                <textarea class="form-control proprietaire-adresse" readonly></textarea>
            </div>
        </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="text" name="numACP" class="form-control">
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group">
                                <label>Date de la création de l'ACP :</label>
                                <input type="date" name="dateED" class="form-control">
                            </div>
                        </div>
                    </div>
                    <div class="row">
